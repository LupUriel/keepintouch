...
- R11a. L'activité, champ de saisie libre, ne figure au profil qu'après avoir été relue et marquée bonne à transmettre dans son état exact. La relecture porte sur le couple dénomination et texte : la valider une fois vaut pour toutes les fiches de cette entreprise portant ce texte **après l'enregistrement** — celles qui le portaient déjà et celles qui viennent de le recevoir par recopie —, et toute modification ultérieure du texte la fait tomber. Une fiche sœur qui a conservé un texte différent, notamment après un refus de remplacement, ne reçoit pas la marque. (Précision apportée en recette de la v1.6.0, le 2026-09-11 : la première réalisation ne marquait que les fiches portant déjà le texte avant recopie, ce que l'utilisateur a jugé incohérent avec la relecture « une fois par entreprise ».) À défaut de relecture, le profil porte le libellé officiel INSEE lorsqu'il existe, et ne porte aucune ligne d'activité sinon ; la fiche reste exportée.
